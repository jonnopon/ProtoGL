var PausedState = function() {
    return new State("paused",
        function init() {
            ...
            GAME.textManager.addString("Paused", "center", 35, new Vec2(GAME.width / 2, GAME.width / 2), new Vec4(255, 255, 255, 1), 0, true);
            GAME.textManager.addString("Space to Continue", "center", 45, new Vec2(GAME.width / 2, 70), new Vec4(255, 255, 255, 0), 0, true, true, 25, new Vec4(255, 255, 255, 1), 1);
        },
        function tick() {
