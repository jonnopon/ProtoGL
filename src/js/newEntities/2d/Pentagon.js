var Pentagon = function(position, col) {
    var entity = new Entity("pentagon");

    var dimensions = new Vec2(20, 20);

    entity.addComponent(new Transform2D(position, dimensions, new Vec2()));
    entity.addComponent(new Shape("pentagon", dimensions));
    ...
    entity.onUpdate = function() {
        this.components.transform2D.angle += (degToRad(3 * this.MULT));
