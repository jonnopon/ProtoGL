var TrianglePyramid = function(position, col) {
    var entity = new Entity("trianglePyramid");

    var dimensions = new Vec3(100, 100, -100);

    entity.addComponent(new Transform3D(position, dimensions, new Vec3()));
    entity.addComponent(new Shape("trianglePyramid", dimensions));
    ...
    // entity.components.transform3D.angle.y = (degToRad(45));
