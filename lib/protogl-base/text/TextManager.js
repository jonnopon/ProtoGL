var TextManager = function(game) {
	...
	this.addString = function(text, align, size, pos, col, angle) {
        ...
        if (angle !== 0) {
            //HACKY OVERRIDE - if you're rotating text I want to cancel the orientation because the startPos is also rotated
            //This can look weird and behave unexpectedly for anything other than left-aligned text. No worries.
            alignInt = -1;
        }
		this.strings.push(
            {
